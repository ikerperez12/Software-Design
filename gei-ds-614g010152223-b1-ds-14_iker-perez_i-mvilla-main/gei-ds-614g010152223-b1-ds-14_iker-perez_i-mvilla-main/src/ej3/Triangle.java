...
public record Triangle (int angle0, int angle1, int angle2) {
    ...
    public boolean equals(Object o) {
        ...
        return(this.angle0!=triangle.angle0 || this.angle1!=triangle.angle1 || this.angle2!=triangle.angle2);
    ...
    public int hashCode() {
        int A;
        return A=Objects.hash(angle0)+Objects.hash(angle1)+Objects.hash(angle2);
    }
}
